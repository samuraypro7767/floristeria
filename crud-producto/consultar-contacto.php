...
<body id="conatiner-nosotros">
    <h1 class="h1">Busqueda</h1>
        <div id="buscardor"> 
             ...
             <a href="../producto.php" class="dir-a">Ver Base De Datos</a>
...
<table class="tabla-buscar">
        ...
        <td> <a href="actualizar-contacto.php?cod_prod=<?php echo $filas['cod_prod']?>"class="dir-a">Editar</a></td>
        <td> <a href="delete-contacto.php?cod_prod=<?php echo $filas['cod_prod']?>"class="dir-a"> Eliminar</a></td>
    </tr>
                        <?php
                        }
                        ?>
