...
<body id="fondoprodu">
        ...
        <form action="../crud-categoria/update-contacto.php" method="POST" class="registration-form ">
...
<div class="registration-container">
    ...
    <input type="number" name="cod_categoria" value="<?php echo $filas['cod_categoria']  ?>" placeholder=" Id" >
    </div>
